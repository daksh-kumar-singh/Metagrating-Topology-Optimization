...
deux_D.TEinc_top_reflected.efficiency{-1,1}   % <--efficacite (TE+TM) dans l'ordre -1,1 pour un incident TE du haut
deux_D.TEinc_bottom_transmitted.efficiency_TE{-1,1}  % <--efficacite TE dans l'ordre -1,1 pour un incident TE du bas
...
conique.TEinc_top_reflected.efficiency{1} % <--efficacite (TE+TM) dans l'ordre 1 pour un incident TE du haut
conique.TEinc_bottom_transmitted.efficiency_TE{1} % <--efficacite TE dans l'ordre 1 pour un incident TE du bas
...
un_D_TE.inc_top_reflected.efficiency{1}  %<--efficacite  dans l'ordre 1 pour un incident TE du haut
...
un_D_TM.inc_top_reflected.efficiency{1} % <--efficacite  dans l'ordre 1 pour un incident TM du haut
